...
mod build_bundled {
    ...
    pub fn main(out_dir: &str, out_path: &Path) {
        ...
        cfg.file(format!("{lib_name}/sqlite3.c"))
            ...
            .flag("-DSQLITE_LIKE_DOESNT_MATCH_BLOBS=1")
            //.flag("-DSQLITE_MAX_EXPR_DEPTH=0")
            //.flag("-DSQLITE_OMIT_DEPRECATED=1")
            //.flag("-DSQLITE_OMIT_PROGRESS_CALLBACK=1")
            //.flag("-DSQLITE_OMIT_SHARED_CACHE=1")
            .flag("-DSQLITE_USE_ALLOCA=1")
            //.flag("-DSQLITE_OMIT_AUTOINIT=1")
            .flag("-DSQLITE_STRICT_SUBTYPE=1")
            .flag("-DSQLITE_ENABLE_NULL_TRIM")
            .flag("-DSQLITE_MAX_MMAP_SIZE=2199023255552")
            .flag("-DHAVE_USLEEP=1")
            .flag("-DHAVE_ISNAN")
